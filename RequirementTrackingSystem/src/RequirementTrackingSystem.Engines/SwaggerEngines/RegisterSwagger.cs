...
namespace RequirementTrackingSystem.Engines.SwaggerEngines;
...
public class RegisterSwagger : IBuilderEngine
{
    ...
    public void Run()
    {
        services.AddSwaggerGen(options =>
        {
            ...
            options.IncludeXmlComments(Path.Combine(basePath, "RequirementTrackingSystem.xml"), true);
            options.IncludeXmlComments(Path.Combine(basePath, "RequirementTrackingSystem.Primary.xml"), true);
            options.IncludeXmlComments(Path.Combine(basePath, "RequirementTrackingSystem.Infrastructure.xml"), true);
