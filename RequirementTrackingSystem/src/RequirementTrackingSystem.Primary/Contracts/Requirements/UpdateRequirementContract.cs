...
public class UpdateRequirementCommand : ICommand, IMapFrom<Requirement>
{
...
public class UpdateRequirementResponse : IResponse
{
    public int Id { get; set; }
}

public interface IUpdateRequirementContract : ICommandContract<UpdateRequirementCommand, UpdateRequirementResponse>
{
}